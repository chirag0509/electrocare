              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                        onPressed: () async {
                          final componentDoc = await FirebaseFirestore.instance
                              .collection("components")
                              .doc(_searchValue)
                              .get();
                          if (componentDoc.exists) {
                            final id = componentDoc.id;
                            final compCategory = componentDoc.get('category');
                            final popular = componentDoc.get('popular');
                            final image = componentDoc.get('image');
                            final rating = componentDoc.get('rating');
                            final mrc = componentDoc.get('mrc');
                            final msc = componentDoc.get('msc');
                            ...
                            final component = ComponentModel(
                                ...
                                sc: sc,
                                dc: dc);
                            Get.to(() => ComponentDetail(component: component));
                          } else {
                            Get.showSnackbar(GetSnackBar(
                              message: '${_searchValue} does not exists.',
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return ListTile(
                                  ...
                                  title: Text(filteredData[index].id),
                                );
                              },
                            );
                          } else {
                        ...
                        child: InkWell(
                          onTap: () {
                            final component = ComponentModel(
                                ...
                                mrc: snapshot.data![index].mrc,
                                msc: snapshot.data![index].msc,
